...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<h3>Alterando Funcionario</h3>\n<div [hidden]=\"\" style=\"width: 400px;\">\n  <form (ngSubmit)=\"onSubmit()\">\n    <div class=\"form-group\">\n      <label for=\"name\">Nome</label>\n      <input\n        type=\"text\"\n        class=\"form-control\"\n        id=\"firstName\"\n        required\n        [(ngModel)]=\"employee.firstName\"\n        name=\"firstName\"\n      />\n    </div>\n\n    <div class=\"form-group\">\n      <label for=\"name\">Sobrenome</label>\n      <input\n        type=\"text\"\n        class=\"form-control\"\n        id=\"lastName\"\n        required\n        [(ngModel)]=\"employee.lastName\"\n        name=\"lastName\"\n      />\n    </div>\n\n    <div class=\"form-group\">\n      <label for=\"name\">Email</label>\n      <input\n        type=\"text\"\n        class=\"form-control\"\n        id=\"emailId\"\n        required\n        [(ngModel)]=\"employee.emailId\"\n        name=\"emailId\"\n      />\n    </div>\n\n    <button type=\"submit\" class=\"btn btn-success\">Submit</button>\n  </form>\n</div>\n");
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _model_employee_model__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../model/employee.model */ "./src/app/model/employee.model.ts");
...
/* harmony import */ var _service_employee_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../service/employee.service */ "./src/app/service/employee.service.ts");
...
let EmployeeService = class EmployeeService {
    ...
    createEmployee(employee) {
        return this.http.post(`${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].baseUrl}`, employee);
    }
    updateEmployee(id, value) {
        return this.http.put(`${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].baseUrl}/${id}`, value);
    }
    deleteEmployee(id) {
        return this.http.delete(`${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].baseUrl}/${id}`, { responseType: 'text' });
    }
    getEmployeesList() {
...
module.exports = __webpack_require__(/*! D:\Angular-MongoDB-FrontEnd\src\main.ts */"./src/main.ts");
